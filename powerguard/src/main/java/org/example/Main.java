    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (retrainNeeded) {
                ...
                System.out.println("Best model (lowest RMSE): " + benchmark.bestResult.modelName);
                System.out.printf("Best model RMSE: %.5f | Accuracy: %.2f%%%n", benchmark.bestResult.rmse, benchmark.bestResult.accuracyPercent);
                ...
                if (!GraphicsEnvironment.isHeadless()) {
                    JOptionPane.showMessageDialog(
                            null,
                            "Benchmark complete.\nBest Model (lowest RMSE): " + benchmark.bestResult.modelName + "\n" + benchmark.bestResult
                    );
                }
            } else {
